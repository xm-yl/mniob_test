...
RC VacuousTrx::update_record(Table *table, Record &record, std::vector<const Value*> update_values,std::vector<const FieldMeta*> update_fields){
  return table->update_record(record,update_values,update_fields);
}
